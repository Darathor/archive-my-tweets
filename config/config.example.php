...
define('TWITTER_ID', 0); // e.g. Your user id (it is retrieved during the install process)
...
// ui configuration.
define('AMT_THEME', 'default');
define('AMT_LCID', 'fr_FR');
define('AMT_TIMEZONE', 'Europe/Paris');